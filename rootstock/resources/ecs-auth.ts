      ...
      JSON.stringify([
        {
          ...
          environment: [
            ...
            { name: "RP_ID", value: domainConfig.domainName },
            { name: "RP_ORIGIN", value: `https://${domainConfig.domainName}` },
            { name: "AUTH_BASE_URL", value: `https://${domainConfig.domainName}` },
            { name: "OTP_FROM_EMAIL", value: `noreply@${domainConfig.domainName}` },
          ],
          logConfiguration: {
            logDriver: "awslogs",
            options: {
