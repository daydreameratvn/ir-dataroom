const translations = {
  ...
  portal: {
    ...
    claims: {
      ...
      noClaimsFilterDesc: 'Thử điều chỉnh tìm kiếm hoặc bộ lọc.',
      noClaimsEmptyDesc: 'Chưa có bồi thường nào được gửi.',
      submitClaim: 'Gửi bồi thường',
      ...
      date: 'Ngày',
      created: 'Ngày tạo',
      pagination: 'Trang {{page}} / {{totalPages}} ({{total}} bồi thường)',
  ...
  auth: {
    ...
    login: {
      ...
      signIn: 'Đăng nhập',
      authkitHint: 'Đăng nhập bằng SSO, email hoặc passkey',
      otherMethods: 'Tùy chọn đăng nhập khác',
